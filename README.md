...
예시 파일을 복사해 `env/.env.development`를 만들고 자신의 값으로 수정합니다.
...
PORT=5005
DATABASE_URL=postgresql://postgres:<password>@localhost:5432/movie_review
TMDB_BASE_URL=https://api.themoviedb.org/3
TMDB_API_KEY=<tmdb-api-key>
```

`<password>`와 `<tmdb-api-key>`는 자신의 값으로 바꾸고 꺾쇠괄호를 제거합니다. TMDB API 키는 [TMDB API 설정](https://www.themoviedb.org/settings/api)에서 발급하며 Git에 커밋하지 않습니다.
